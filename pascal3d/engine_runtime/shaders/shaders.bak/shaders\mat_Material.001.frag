...
uniform vec3 unf51;
uniform float unf55;
const float cons65 = float(0.800000);
uniform vec4 unf68;
const float cons70 = float(1.000000);
const vec4 cons74 = vec4(1.000000, 1.000000, 1.000000, 0.005000);
const vec4 cons80 = vec4(0.800000, 0.800000, 0.800000, 0.000000);
const float cons85 = float(50.000000);
const float cons88 = float(0.500000);
uniform vec3 unf93;
const vec3 cons94 = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 unf100;
uniform float unf104;
const float cons114 = float(0.800000);
uniform vec4 unf117;
const float cons119 = float(1.000000);
const vec4 cons123 = vec4(1.000000, 1.000000, 1.000000, 0.005000);
const vec4 cons129 = vec4(0.800000, 0.800000, 0.800000, 0.000000);
const float cons134 = float(50.000000);
const float cons137 = float(0.500000);
uniform vec3 unf142;
const vec3 cons143 = vec3(1.000000, 1.000000, 1.000000);
uniform vec3 unf149;
uniform float unf153;
const float cons163 = float(0.800000);
uniform vec4 unf166;
const float cons168 = float(1.000000);
const vec4 cons172 = vec4(1.000000, 1.000000, 1.000000, 0.005000);
const vec4 cons178 = vec4(0.800000, 0.800000, 0.800000, 0.000000);
const float cons183 = float(50.000000);
const float cons186 = float(0.500000);
uniform vec3 unf191;
const vec3 cons192 = vec3(1.000000, 1.000000, 1.000000);
const float cons201 = float(1.000000);
...
void main(void)
{
	...
	shade_madd_clamped(vec4(tmp5, 1.0), tmp26, cons31, tmp32);
	...
	lamp_visibility_other(varposition, unf51, tmp52, tmp53, tmp54);
	lamp_falloff_invsquare(unf55, tmp53, tmp57);
	lamp_visibility_clamp(tmp57, tmp59);
	shade_inp(tmp2, tmp52, tmp62);
	shade_visifac(tmp62, tmp59, cons65, tmp66);
	shade_mul_value(tmp66, unf68, tmp69);
	mtex_value_invert(cons70, tmp71);
	mix_mult(tmp71, tmp69, cons74, tmp75);
	mtex_value_invert(tmp71, tmp77);
	shade_madd_clamped(tmp32, tmp75, cons80, tmp81);
	shade_cooktorr_spec(tmp2, tmp52, tmp4, cons85, tmp86);
	shade_spec_t(tmp77, cons88, tmp59, tmp86, tmp91);
	shade_add_spec(tmp91, unf93, cons94, tmp95);
	shade_add_clamped(tmp49, vec4(tmp95, 1.0), tmp98);
	lamp_visibility_other(varposition, unf100, tmp101, tmp102, tmp103);
	lamp_falloff_invsquare(unf104, tmp102, tmp106);
	lamp_visibility_clamp(tmp106, tmp108);
	shade_inp(tmp2, tmp101, tmp111);
	shade_visifac(tmp111, tmp108, cons114, tmp115);
	shade_mul_value(tmp115, unf117, tmp118);
	mtex_value_invert(cons119, tmp120);
	mix_mult(tmp120, tmp118, cons123, tmp124);
	mtex_value_invert(tmp120, tmp126);
	shade_madd_clamped(tmp81, tmp124, cons129, tmp130);
	shade_cooktorr_spec(tmp2, tmp101, tmp4, cons134, tmp135);
	shade_spec_t(tmp126, cons137, tmp108, tmp135, tmp140);
	shade_add_spec(tmp140, unf142, cons143, tmp144);
	shade_add_clamped(tmp98, vec4(tmp144, 1.0), tmp147);
	lamp_visibility_other(varposition, unf149, tmp150, tmp151, tmp152);
	lamp_falloff_invsquare(unf153, tmp151, tmp155);
	lamp_visibility_clamp(tmp155, tmp157);
	shade_inp(tmp2, tmp150, tmp160);
	shade_visifac(tmp160, tmp157, cons163, tmp164);
	shade_mul_value(tmp164, unf166, tmp167);
	mtex_value_invert(cons168, tmp169);
	mix_mult(tmp169, tmp167, cons172, tmp173);
	mtex_value_invert(tmp169, tmp175);
	shade_madd_clamped(tmp130, tmp173, cons178, tmp179);
	shade_cooktorr_spec(tmp2, tmp150, tmp4, cons183, tmp184);
	shade_spec_t(tmp175, cons186, tmp157, tmp184, tmp189);
	shade_add_spec(tmp189, unf191, cons192, tmp193);
	shade_add_clamped(tmp147, vec4(tmp193, 1.0), tmp196);
	shade_add(tmp179, tmp196, tmp199);
	mtex_alpha_to_col(tmp199, cons201, tmp202);
	shade_alpha_opaque(tmp202, tmp204);
	linearrgb_to_srgb(tmp204, tmp206);
