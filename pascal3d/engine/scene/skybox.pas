...
uses
  Classes, SysUtils, texture_sdl, shaders, scene, Math3D, dglOpenGL, Model;
...
type
  ...
  TSkyBoxSimple = class
    private
      FTextureRLFR: TSDLSurface;
      FTextureTB: TSDLSurface;
      Cube: TModel;
    ...
    published
      property TextureRLFR: TSDLSurface read FTextureRLFR write FTextureRLFR;
      property TextureTB: TSDLSurface read FTextureTB write FTextureTB;
  end;
