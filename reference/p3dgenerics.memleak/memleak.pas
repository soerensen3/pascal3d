...
uses Classes, sysutils, Math, fgl;
  ...
  type
    ...
    = class ( TInterfacedPersistent{, specialize IP3DEnumerableClass < TCustomItem >} )
      type
      ...
      public
        ...
        function GetEnumerator: TP3DCustomObjectListEnumeratorClass;
        function Reversed(): TP3DCustomObjectListEnumeratorClass;
...
type
  ITestInterface = interface
    procedure WriteTestMessage;
  end;

  TObj = class ( TInterfacedPersistent, ITestInterface )
    procedure WriteTestMessage;
  end;

  TObjList = specialize fgl.TFPGList < ITestInterface >;

{ TObj }

procedure TObj.WriteTestMessage;
begin
  WriteLn( 'Test123' );
end;
...
begin
  ...
  TestItem:= TObj.Create;
  ObjList.Add( TestItem );
  FreeAndNil( ObjList );
  TestItem.Free;
end.
