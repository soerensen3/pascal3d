...
const vec3 cons15 = vec3(0.800000, 0.800000, 0.800000);
const float cons18 = float(1.000000);
uniform vec3 unf21;
const float cons30 = float(0.800000);
uniform vec4 unf33;
const float cons35 = float(1.000000);
const vec4 cons39 = vec4(1.000000, 1.000000, 1.000000, 0.005000);
varying vec3 varposition;
uniform vec3 unf46;
uniform float unf50;
const float cons60 = float(0.800000);
uniform vec4 unf63;
const float cons65 = float(1.000000);
const vec4 cons69 = vec4(1.000000, 1.000000, 1.000000, 0.005000);
uniform vec3 unf76;
uniform float unf80;
const float cons90 = float(0.800000);
uniform vec4 unf93;
const float cons95 = float(1.000000);
const vec4 cons99 = vec4(1.000000, 1.000000, 1.000000, 0.005000);
uniform vec3 unf106;
uniform float unf110;
const float cons120 = float(0.800000);
uniform vec4 unf123;
const float cons125 = float(1.000000);
const vec4 cons129 = vec4(1.000000, 1.000000, 1.000000, 0.005000);
const float cons136 = float(1.000000);
...
void main(void)
{
	...
	set_rgb_zero(tmp20);
	lamp_visibility_sun_hemi(unf21, tmp22, tmp23, tmp24);
	shade_inp(tmp2, tmp22, tmp27);
	shade_visifac(tmp27, tmp24, cons30, tmp31);
	shade_mul_value(tmp31, unf33, tmp34);
	mtex_value_invert(cons35, tmp36);
	mix_mult(tmp36, tmp34, cons39, tmp40);
	shade_madd_clamped(vec4(tmp20, 1.0), tmp40, vec4(tmp19, 1.0), tmp44);
	...
	shade_inp(tmp2, tmp47, tmp57);
	shade_visifac(tmp57, tmp54, cons60, tmp61);
	shade_mul_value(tmp61, unf63, tmp64);
	mtex_value_invert(cons65, tmp66);
	mix_mult(tmp66, tmp64, cons69, tmp70);
	shade_madd_clamped(tmp44, tmp70, vec4(tmp19, 1.0), tmp74);
	lamp_visibility_other(varposition, unf76, tmp77, tmp78, tmp79);
	lamp_falloff_invsquare(unf80, tmp78, tmp82);
	lamp_visibility_clamp(tmp82, tmp84);
	shade_inp(tmp2, tmp77, tmp87);
	shade_visifac(tmp87, tmp84, cons90, tmp91);
	shade_mul_value(tmp91, unf93, tmp94);
	mtex_value_invert(cons95, tmp96);
	mix_mult(tmp96, tmp94, cons99, tmp100);
	shade_madd_clamped(tmp74, tmp100, vec4(tmp19, 1.0), tmp104);
	lamp_visibility_other(varposition, unf106, tmp107, tmp108, tmp109);
	lamp_falloff_invsquare(unf110, tmp108, tmp112);
	lamp_visibility_clamp(tmp112, tmp114);
	shade_inp(tmp2, tmp107, tmp117);
	shade_visifac(tmp117, tmp114, cons120, tmp121);
	shade_mul_value(tmp121, unf123, tmp124);
	mtex_value_invert(cons125, tmp126);
	mix_mult(tmp126, tmp124, cons129, tmp130);
	shade_madd_clamped(tmp104, tmp130, vec4(tmp19, 1.0), tmp134);
	mtex_alpha_to_col(tmp134, cons136, tmp137);
	shade_alpha_opaque(tmp137, tmp139);
	linearrgb_to_srgb(tmp139, tmp141);
