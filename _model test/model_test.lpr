...
begin
  ...
  Mdl:= LoadModelFileFromFile( 'test2.model' );
  WriteLn( Mdl.Debug );
end;
...
procedure Draw;
    ...
    begin
      ...
      view:= Mat4Identity;
      view*= Mat4Rot( Vec3( 0.0, 1.0, 0.0 ), deg2rad* yrot );
      view*= Mat4Rot( Vec3( 1.0, 0.0, 0.0 ), deg2rad* xrot );
//      view3x3:= view;
      view:= MatrixTranslate( vec4( 0, 0, Zoom, 0 )) * view;
//      MatrixInverse( view, invview );
      ...
      glGetFloatv( GL_PROJECTION_MATRIX, @zglMat );
