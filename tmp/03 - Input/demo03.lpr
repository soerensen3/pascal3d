...
var
  dirRes  : UTF8String {$IFNDEF MACOSX} = '../../../zengl-src-0.3.12/bin/data/' {$ENDIF};
...
begin
  ...
  text_Draw( fntMain, 0, 16, Format( 'Mouse X: %d, Y: %d, dx: %d, dy: %d', [ mouse_X(), mouse_Y(), mouse_DX(), mouse_DY() ]));
